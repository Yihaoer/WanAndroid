package com.yihaoer.wyh.wanandroid.app.base;
...
/**
 * Author: Yihaoer
 * Description: 基于Fragmentation框架和Arms框架，做为Activity的基类
 */
public abstract class SupportActivity<P extends IPresenter> extends BaseActivity<P> implements ISupportActivity {
