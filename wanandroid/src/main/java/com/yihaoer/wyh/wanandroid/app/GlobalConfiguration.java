package com.yihaoer.wyh.wanandroid.app;
...
import com.header.imageloaderlib.interImpl.GlideLoader;
import com.header.imageloaderlib.interImpl.PicassoLoader;
import com.header.imageloaderlib.interImpl.UniversalImageLoader;
...
import com.yihaoer.wyh.wanandroid.app.config.options.MyRetrofitConfiguration;
import com.yihaoer.wyh.wanandroid.app.config.options.MyRxCacheConfiguration;
 ...
 * Created by MVPArmsTemplate on 01/20/2019 18:02
...
public final class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        //                });
        //初始化配置
        builder.baseurl(Api.WANANDROID_URL)
