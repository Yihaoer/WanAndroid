...
/**
 * Author: Yihaoer
 * Description: 基于Fragmentation框架和Arms框架，做为Fragment的基类
 */
public abstract class SupportFragment<P extends IPresenter> extends BaseFragment<P> implements ISupportFragment {
